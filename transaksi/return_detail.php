...
<a class="btn btn-sm btn-success ml-3" href="transaksi_status.php?id_transaksi=<?= $id_transaksi; ?>&status=8" onclick="return confirm('Terima Pesanan?');" class='btn btn-success'>Terima Ajuan Return</a>
    ...
    <section>
        ...
        <table class="tables total-result">
            ...
            <tr>
                ...
                <td>
                    <h6><?php echo $dataReturn['alasan_return']; ?></h6>
                </td>
            </tr>
            <tr>
                <td>Bukti Retur : </td>
                <td>
                    ...
                    if (!empty($dataReturn['gambar'])) {
                        echo '<img src="../bahan_baku/bukti_return/' . $dataReturn['gambar'] . '" alt="Bukti Retur" style="max-width: 200px;">';
                    } else {
