                                        ...
                                        <tr>
                                            ...
                                            <td class="no-print">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <form action="customer_pembayaran_act.php" method="post" enctype="multipart/form-data">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <small style="color:#0A0224;" class="text-muted">Note: File Hanya
                                                                                        format JPG atau JPEG</small>
                                                                                </div>
                                                ...
                                                <?php } elseif ($data['status'] == "4") { ?>
                                                    <a style="background-color:green;color:white;" onclick="return confirm('Apakah anda sudah menerima pesanan?');" class='btn btn-sm btn-default' href="customer_update.php?id=<?php echo $data[0]; ?>">Konfirmasi
                                                        Pesanan</a>
                                                <?php } ?>
                                            </td>
                                            <td>
